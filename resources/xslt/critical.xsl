...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:foo="whatever" xmlns:tei="http://www.tei-c.org/ns/1.0" exclude-result-prefixes="tei" version="2.0"><!-- <xsl:strip-space elements="*"/>-->
    ...
    <xsl:variable name="quotationString">
        <xsl:value-of select="concat('Arthur Schnitzler: Briefwechsel mit Autorinnen und Autoren. Digitale Edition. Hg. Martin Anton Müller und Gerd Hermann Susen', $doctitle, ', ', $quotationURL, ' (Stand ', $currentDate, ')')"/>
    </xsl:variable>
                            ...
                            <h1>
                                <a>
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="concat(substring-before($prev,'&amp;directory'),'&amp;stylesheet=critical')"/>
                                    </xsl:attribute>
                    ...
                    <div class="col-md-2" style="text-align:right">
                        <xsl:if test="$next">
                            <h1>
                                <a>
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="concat(substring-before($next,'&amp;directory'),'&amp;stylesheet=critical')"/>
                                    </xsl:attribute>
            ...
            <div class="card-body">
                ...
                <div>
                                    ...
                                    <h5>
                                        <a>
                                            <xsl:attribute name="href">
                                                ...
                                                <xsl:value-of select="concat('show.html?document=',$name-of-document,'.xml&amp;stylesheet=critical')"/>
                                            </xsl:attribute>
                    ...
                    <p style="text-align:center;">
                        ...
                        <a class="ml-3" id="res-act-button-copy-url" data-copyuri="{$quotationURL}">
                        ...
                        <!-- code for different views comes here -->
                        <a class="ml-3">
                            <xsl:attribute name="href">
