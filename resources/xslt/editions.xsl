                        ...
                        <xsl:if test="$prev">
                                    <h1>
                                        <a>
                                            ...
                                            <i class="fas fa-chevron-left" title="previous letter"/>
                                        </a>
                                    </h1>
                        </xsl:if>
                    </div>
                        ...
                        <xsl:if test="$next">
                            <h1>
                                <a>
                                    ...
                                    <i class="fas fa-chevron-right" title="next letter"/>
                                </a>
                            </h1>
                        </xsl:if>
                            ...
                            <h5>
                                <a>
                                    <xsl:attribute name="href">
                                        ...
                                        <xsl:value-of select="concat('show.html?document=',$name-of-document,'.xml&amp;directory=editions')"/>
                                    </xsl:attribute>
