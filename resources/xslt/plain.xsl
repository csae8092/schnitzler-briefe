                            ...
                            <h1>
                                <a>
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="concat(substring-before($prev,'&amp;directory'),'&amp;stylesheet=plain')"/>
                                    </xsl:attribute>
                    ...
                    <div class="col-md-2" style="text-align:right">
                        <xsl:if test="$next">
                            <h1>
                                <a>
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="concat(substring-before($next,'&amp;directory'),'&amp;stylesheet=plain')"/>
                                    </xsl:attribute>
                                    ...
                                    <h5>
                                        <a>
                                            <xsl:attribute name="href">
                                                ...
                                                <xsl:value-of select="concat('show.html?document=',$name-of-document,'.xml&amp;stylesheet=plain')"/>
                                            </xsl:attribute>
